                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          const Text("Plastic Cover Used?"),
                          Switch(
                            value: plasticCoverUsed,
                            onChanged: (val) {
                              setState(() {
                                plasticCoverUsed = val;
                              });
                            },
                          )
                        ],
                      ...
                      if (plasticCoverUsed)
                        Column(
                          children: [
                            RadioListTile(
                              title: const Text("Black Down"),
                              value: "Black Down",
                              groupValue: plasticCoverColor,
                              onChanged: (val) {
                                setState(() => plasticCoverColor = val);
                              },
                            ),
                            RadioListTile(
                              title: const Text("White Up"),
                              value: "White Up",
                              groupValue: plasticCoverColor,
                              onChanged: (val) {
                                setState(() => plasticCoverColor = val);
                      ...
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          const Text("Planting Holes Created?"),
                          Switch(
                            value: plantingHoles,
                            onChanged: (val) {
                              setState(() => plantingHoles = val);
                            },
                          )
                        ],
                      ),
                      ...
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          const Text("Dani Holes Machine Used?"),
                          Switch(
                            value: daniHolesMachine,
                            onChanged: (val) {
                              setState(() => daniHolesMachine = val);
                            },
                          )
                        ],
                      ),
                      ...
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          const Text("Roller Used?"),
                          Switch(
                            value: rollerUsed,
                            onChanged: (val) {
                              setState(() => rollerUsed = val);
                            },
                          )
                        ],
                      ),
